...
import { IModelRepository, IQueryBuilderRepository, Payments } from "data-provider";
    ...
    providers: [
        {
            ...
            useFactory: (repository: IQueryBuilderRepository<Payments>) => {
                const mapper: IMapper<Payments, PaymentDto> = new Mapper<Payments, PaymentDto> (Payments, PaymentDto)
