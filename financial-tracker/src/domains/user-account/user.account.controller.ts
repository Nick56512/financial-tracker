...
export class UserAccountController {
   constructor(
      @Inject(INJECTION_KEYS.UserAccountService)
      private readonly userAccountService: IUserAccountService,
      @Inject(INJECTION_KEYS.VerificationManager)
      private readonly verificationManager: IVerificationManager,
      @Inject(INJECTION_KEYS.EmailProvider)
   ...
   public async verify(@Body() verificationPayload: VerificationPayload) {
      ...
      const verificationSuccess = await this.verificationManager.verificate(
         cacheStoreKey,
      ...
      const existsUser = await this.userAccountService.findUserByEmail(
   ...
   public async setAccountInfo(
      @Body() accountInfo: SetAccountInfoPayload,
